...
declare global {
  interface Window {
    DeviceMotionEvent: DeviceMotionEventConstructorWithPermission & typeof DeviceMotionEvent;
  }
}
...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  ...
  useEffect(() => {
    ...
    const handleClick = () => {
      ...
      if (!enableMobileTilt || window.innerWidth > 1024 || location.protocol !== 'https:') return;
  ...
  return (
    <div
      ...
      style={cardStyle}
    >
      <section ref={cardRef} className="pc-card m-auto">
              ...
              <div className="pc-user-info">
                <div className="pc-user-details">
                  ...
                  <div className="pc-user-text">
                    ...
                    <div className="pc-status">Shivansh Infosys</div>
