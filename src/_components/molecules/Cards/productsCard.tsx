    ...
    <div className="flex h-full flex-col overflow-hidden rounded-lg bg-white shadow-md transition-all duration-300 hover:shadow-lg">
      ...
      <div className="group relative">
        ...
        <button
          ...
          className="bg-opacity-50 absolute inset-0 flex items-center justify-center bg-black opacity-0 transition-opacity duration-300 group-hover:opacity-100"
        >
      ...
      <div className="flex flex-1 flex-col p-4">
        ...
        <h3 className="mb-2 line-clamp-2 text-base font-semibold md:text-lg hover:text-red-700">
          {product.title}
        </h3>
        </Link>
        <Link href={`/product/${product.id}`}>
        ...
        <button className="focus:ring-opacity-50 mt-auto w-full transform rounded-lg bg-[#C50202] px-4 py-2.5 text-sm font-medium text-white transition-all duration-300 hover:-translate-y-0.5 hover:bg-[#A00303] hover:shadow-[0_6px_12px_rgba(197,2,2,0.25)] focus:ring-2 focus:ring-[#C50202] focus:outline-none md:py-2 md:text-base">
          Enquiry Now
        </button>
      </div>
    </div>
