...
//           </span>
//         </h1>
//         <p className="mt-2 font-[400] text-gray-700 sm:mt-4 sm:text-lg md:text-xl lg:text-lg">
//           Tally Certified 3-Star Partner · 3000+ Customers Served in all Over
//           India
//         </p>

//         {/* Stats */}
//         <div className="grid grid-cols-2 gap-6 border-t border-gray-200 pt-8 dark:border-slate-200">
...
//           className="font-[700] tracking-[3px]"
//           external
//         >
//           Watch on YouTube
//         </Button>
//         <Button
//           href="https://bitly.cx/rNEH4"
//           className="font-[700] tracking-[3px] mx-2"
//           external
//         >
//           Call For Demo
//         </Button>
...
//       <h1
//         id="hero-heading"
//         className="text-3xl font-[600] text-gray-900 sm:text-4xl md:text-5xl lg:text-6xl leading-tight"
//       >
//         Empowering Businesses with{" "}
//         <span className="text-(--primery-color)">
//           Trusted Tally Solutions
...
//       {/* Subheading */}
//       <p className="mt-2 font-[400] text-gray-700 sm:mt-4 sm:text-lg md:text-xl lg:text-lg max-w-2xl">
//         Tally Certified 3-Star Partner · 3000+ Customers Served in all Over India
//       </p>

//       {/* Feature Points */}
//       <div className="grid grid-cols-1 md:grid-cols-2 gap-4 py-4">
//         <div className="flex items-center space-x-3">
//           <div className="w-2 h-2 bg-(--primery-color) rounded-full"></div>
//           <span className="text-gray-600 font-medium">Expert Tally Support</span>
//         </div>
//         <div className="flex items-center space-x-3">
//           <div className="w-2 h-2 bg-(--primery-color) rounded-full"></div>
//           <span className="text-gray-600 font-medium">24/7 Customer Service</span>
//         </div>
//         <div className="flex items-center space-x-3">
//           <div className="w-2 h-2 bg-(--primery-color) rounded-full"></div>
//           <span className="text-gray-600 font-medium">Custom Solutions</span>
//         </div>
//         <div className="flex items-center space-x-3">
//           <div className="w-2 h-2 bg-(--primery-color) rounded-full"></div>
//           <span className="text-gray-600 font-medium">Training & Setup</span>
//         </div>
//       </div>
...
//         <Button
//           href="https://bitly.cx/rNEH4"
//           className="font-[700] tracking-[3px] transform hover:scale-105 transition-transform duration-200"
//           external
//         >
//           Watch on YouTube
//         </Button>
