  ...
  return (
    <>
      <section className="bg-white py-19 sm:py-12 md:py-16 lg:py-20 xl:py-24 2xl:py-28">
        ...
        {/* Action Buttons */}
        <div className="relative z-10 -mt-[150px] flex flex-col justify-center space-y-4 px-3 pt-2 sm:mt-0 sm:flex-row sm:space-y-0 sm:space-x-4 sm:px-1">
          <button
          ...
          <Link href={SERVICE}>
            <button
              className="flex w-full transform cursor-pointer items-center justify-center gap-2 rounded-lg border-2 border-(--primery-color) border-[#A00303] bg-white px-6 py-3 font-bold tracking-wide text-(--primery-color) transition duration-300 hover:-translate-y-0.5 hover:border-2 hover:bg-[#A00303] hover:text-white hover:shadow-[4px_4px_0px_0px_rgba(0,0,0)]"
