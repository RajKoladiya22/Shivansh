...
>
  {selectedVideo && (
    <div className="flex h-full w-full flex-col lg:flex-row">
      {/* Main Video Section */}
      <div className="flex flex-1 flex-col lg:flex-[3] bg-black">
        {/* Video Header */}
        <div className="flex items-center justify-between px-4 py-3 bg-black/80 text-white">
          <h2 className="text-base sm:text-lg font-medium truncate pr-2">
            {selectedVideo.title}
          </h2>
          <button 
            onClick={closeVideo}
        ...
        <div className="relative flex-1 flex items-center justify-center p-2 sm:p-4">
          <div className="relative w-full max-w-4xl aspect-video bg-gray-900 rounded-lg overflow-hidden shadow-xl">
            <VideoIframe
              video={selectedVideo}
      ...
      {/* Comments Section */}
      <div className="flex flex-col w-full h-[40vh] lg:h-full lg:w-80 xl:w-96 bg-white border-t lg:border-t-0 lg:border-l border-gray-200">
        {/* Comments Header */}
        <div className="flex items-center justify-between px-4 py-3 border-b border-gray-200 bg-white">
          <h3 className="text-base font-medium text-gray-900">
            Comments <span className="text-gray-500">({commentItems.length})</span>
          </h3>
