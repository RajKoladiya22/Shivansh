...
//   {
//     question: "What is the warranty for this product?",
//     answer: "We offer a 1-year warranty on all our products against manufacturing defects. Warranty covers parts and labor for any issues arising during normal use."
//   },
//   {
//     question: "How long does shipping take?",
//     answer: "Standard shipping takes 5-7 business days. Express shipping options are available at checkout with delivery in 2-3 business days. International shipping times vary by location."
//   },
//   {
//     question: "Can I return the product if I'm not satisfied?",
//     answer: "Yes, we offer a 30-day money-back guarantee. Products must be in original condition with all packaging. Return shipping costs are the responsibility of the customer."
//   },
//   {
//     question: "What payment methods do you accept?",
//     answer: "We accept all major credit cards (Visa, Mastercard, American Express), PayPal, bank transfers, and UPI payments. Corporate billing options are available for business customers."
//   },
//   {
//     question: "Do you offer bulk discounts?",
//     answer: "Yes, we offer volume discounts for orders over 10 units. Discounts range from 5-15% depending on quantity. Contact our sales team for custom quotes on large orders."
//   },
//   {
//     question: "How can I track my order?",
//     answer: "Once your order ships, you'll receive a tracking number via email. You can track your package using our order tracking page or directly with the shipping carrier."
//   },
// ];

// export const TheProductDetailPage: React.FC<{ params: { id: string } }> = ({ params }) => {
//   const [selectedImageIndex, setSelectedImageIndex] = useState<number>(0);
...
//   if (!product) {
//     return (
//       <div className="flex min-h-screen items-center justify-center bg-[#FCF2F2]">
...
//           <button
//             onClick={() => window.history.back()}
//             className="rounded-lg bg-[#C50202] px-6 py-3 font-medium text-white hover:bg-[#A00303] transition-colors"
//           >
//             Go Back
//           </button>
//         </div>
...
//     alert(`Enquiry submitted for ${quantity} units of ${product.title}`);
//   };
...
//   return (
//     <div className="min-h-screen bg-[#FCF2F2] pt-20">
//       {/* Navigation Bar */}
...
//                   isFavorite
//                     ? "bg-[#FFCCD6] text-[#C50202]"
//                     : "text-gray-400 hover:text-[#C50202]"
//                 }`}
//               >
//                 <Heart
...
//               <button
//                 onClick={handleShare}
//                 className="rounded-full p-2 text-gray-400 hover:text-[#C50202]"
//               >
//                 <Share2 className="h-5 w-5" />
//               </button>
//             </div>
...
//               <button
//                 onClick={() => setIsVideoModalOpen(true)}
//                 className="group absolute inset-0 flex items-center justify-center bg-black/0 transition-all duration-300 hover:bg-black/20"
//                 aria-label={`Play product video for ${product.title}`}
//               >
//                 <div className="flex h-16 w-16 items-center justify-center rounded-full bg-white/90 opacity-0 transition-all duration-300 group-hover:opacity-100">
//                   <Play className="h-8 w-8 text-[#C50202] translate-x-0.5" />
//                 </div>
//               </button>
...
//                     selectedImageIndex === index
//                       ? "border-[#C50202] shadow-md"
//                       : "border-gray-200 hover:border-[#C50202]/50"
//                   }`}
//                 >
//                   <Image
//                     width={100}
...
//                   <span className="font-bold">1,235</span> units sold
//                 </span>
//               </div>
...
//               <div className="mb-6 rounded-lg bg-[#FCF2F2] p-4">
//                 <div className="flex items-center justify-between">
...
//                       -
//                     </button>
//                     <span className="border-x px-4 py-2 w-12 text-center">{quantity}</span>
//                     <button
//                       onClick={() => setQuantity(quantity + 1)}
//                       className="px-3 py-2 text-gray-600 hover:bg-gray-50"
//                     >
...
//                 <div className="flex items-center gap-3 rounded-lg bg-[#FCF2F2] p-3">
//                   <Shield className="h-6 w-6 text-[#C50202]" />
//                   <div>
//                     <div className="text-sm font-medium">Quality Assured</div>
//                     <div className="text-xs text-gray-500">
//                       Certified Products
...
//                 </div>
//                 <div className="flex items-center gap-3 rounded-lg bg-[#FCF2F2] p-3">
//                   <Truck className="h-6 w-6 text-[#C50202]" />
//                   <div>
//                     <div className="text-sm font-medium">Fast Delivery</div>
//                     <div className="text-xs text-gray-500">Quick Shipping</div>
//                   </div>
...
//                 <button
//                   onClick={handleEnquiry}
//                   className="w-full rounded-lg bg-gradient-to-r from-[#C50202] to-[#A00303] px-4 py-3 text-lg font-semibold text-white shadow-md transition-all duration-300 hover:shadow-lg hover:from-[#A00303] hover:to-[#800404] focus:outline-none focus:ring-2 focus:ring-[#C50202] focus:ring-opacity-50"
//                 >
//                   Send Enquiry Now
//                 </button>
//               </div>
...
//                 <button className="flex flex-col items-center justify-center gap-1 rounded-lg bg-white p-3 text-center text-sm font-medium text-gray-700 shadow-sm transition-all duration-200 hover:bg-[#FFCCD6] hover:text-[#C50202]">
...
//                       <div className="flex justify-between border-b pb-2">
//                         <dt className="text-gray-500">Industry:</dt>
//                         <dd className="font-medium text-gray-900">{product.industry}</dd>
//                       </div>
//                       <div className="flex justify-between border-b pb-2">
//                         <dt className="text-gray-500">Product ID:</dt>
...
//                       <div className="flex justify-between">
//                         <dt className="text-gray-500">Dimensions:</dt>
//                         <dd className="font-medium text-gray-900">30 × 20 × 15 cm</dd>
//                       </div>
//                     </dl>
//                   </div>
//                   <div>
...
//                 <div className="space-y-4">
//                   {faqs.map((faq, index) => (
//                     <div key={index} className="rounded-lg border border-[#FFCCD6] overflow-hidden">
//                       <button
//                         onClick={() => toggleFaq(index)}
//                         className="flex w-full items-center justify-between p-4 text-left font-medium text-gray-900 hover:bg-[#FCF2F2]"
//                       >
...
//                       </button>
//                       {expandedFaq === index && (
//                         <div className="p-4 bg-white border-t border-[#FFCCD6] text-gray-600">
//                           {faq.answer}
//                         </div>
//                       )}
//                     </div>
...
//               {relatedProducts.map((relatedProduct) => (
//                 <Link href={`${relatedProduct.id}`} key={relatedProduct.id}>
//                   <div className="group cursor-pointer overflow-hidden rounded-xl bg-white shadow-sm transition-all duration-300 hover:shadow-lg">
...
//                           <Play className="h-6 w-6 text-[#C50202]" />
//                         </div>
//                       </div>
//                     </div>
//                     <div className="p-4">
//                       <h3 className="mb-2 line-clamp-2 font-medium text-gray-900 group-hover:text-[#C50202]">
//                         {relatedProduct.title}
//                       </h3>
//                       <div className="flex items-center gap-2">
//                         <span className="text-lg font-bold text-[#C50202]">
...
//                   <div className="flex h-16 w-16 items-center justify-center rounded-full bg-[#C50202]">
//                     <Play className="h-8 w-8 text-white" />
//                   </div>
//                 </div>
//                 <p className="text-lg">Product Video Player</p>
