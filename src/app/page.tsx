...
export async function generateMetadata(): Promise<Metadata> {
  const title = "Tally Solutions Partner | Accounting Software Experts | Shivansh Infosys";
  const description = "Tally Certified 3-Star Partner serving 3000+ businesses. Expert TDL customization, GST compliance & accounting solutions. Free consultation!";
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Shivansh Infosys - Trusted Tally Solutions Partner",
        },
      ],
    },
    twitter: {
  ...
  return (
    <>
      ...
      <div className="sr-only" aria-hidden="true">
        ...
        <p>Trusted Tally Certified Partner serving 3000+ clients across India</p>
        <p>Expert TDL customization, GST compliance solutions, and business accounting services</p>
        <p>Professional tax solutions, financial consulting, and business advisory for SMEs</p>
        <ul>
