...
import { TheTallyImplementationPage } from "src/_components/sections/tally-implementation";
...
export default async function TallyImplementationPage() {
  // Structured Data
