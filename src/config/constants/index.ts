...
export const hero_heading_font = "text-base font-[400] tracking-[3px] text-(--primery-color) text-sm  md:text-lg lg:text-xl"
export const hero_headline_font = "text-3xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl leading-tight font-bold text-gray-900"
export const hero_content_font = "text-sm leading-relaxed text-gray-700  sm:text-base md:text-lg lg:text-xl"
...
export const btn_color = "cursor-pointer bg-gradient-to-r from-[#C50202] to-[#A00000] text-white hover:-translate-y-0.5 hover:shadow-[4px_4px_0px_0px_rgba(0,0,0)] transition duration-300  hover:bg-[#A00303]"
